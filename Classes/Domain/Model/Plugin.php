...
class Plugin
{
   ...
   */
  public function __construct(string $extensionKey, string $pluginName, array $controllerActions, array $nonCacheableControllerActions, string $iconFileName, ?string $wizardGroupId = null, string $flexFormFileName = '', string $pluginType = ExtensionUtility::PLUGIN_TYPE_CONTENT_ELEMENT)
  {
