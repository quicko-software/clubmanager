    ...
    'columns'   => [
        ...
        'state' => [
            ...
            'config'  => [
                ...
                'size'       => 1,
                'items' => [
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang_db.xlf:tx_clubmanager_domain_model_member.state.unset', \Quicko\Clubmanager\Domain\Model\Member::STATE_UNSET],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang_db.xlf:tx_clubmanager_domain_model_member.state.applied', \Quicko\Clubmanager\Domain\Model\Member::STATE_APPLIED],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang_db.xlf:tx_clubmanager_domain_model_member.state.active', \Quicko\Clubmanager\Domain\Model\Member::STATE_ACTIVE],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang_db.xlf:tx_clubmanager_domain_model_member.state.suspended', \Quicko\Clubmanager\Domain\Model\Member::STATE_SUSPENDED],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang_db.xlf:tx_clubmanager_domain_model_member.state.cancelled', \Quicko\Clubmanager\Domain\Model\Member::STATE_CANCELLED],
                ],
            ],
        ],
        'cancellation_wish' => [
