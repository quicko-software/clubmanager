    ...
    'columns' => [
        ...
        'found_via' => [
            ...
            'config' => [
                ...
                'renderType' => 'selectSingle',
                'items' => [
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang.xlf:tx_clubmanager_domain_model_member.found_via.0', Quicko\Clubmanager\Domain\Model\Member::FOUND_VIA_UNKOWN],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang.xlf:tx_clubmanager_domain_model_member.found_via.10', Quicko\Clubmanager\Domain\Model\Member::FOUND_VIA_RECOMMENDATION],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang.xlf:tx_clubmanager_domain_model_member.found_via.20', Quicko\Clubmanager\Domain\Model\Member::FOUND_VIA_SOCIALMEDIA],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang.xlf:tx_clubmanager_domain_model_member.found_via.30', Quicko\Clubmanager\Domain\Model\Member::FOUND_VIA_PRESS],
                    ['LLL:EXT:clubmanager/Resources/Private/Language/locallang.xlf:tx_clubmanager_domain_model_member.found_via.40', Quicko\Clubmanager\Domain\Model\Member::FOUND_VIA_MISC],
                ],
                'size' => 1,
                'maxitems' => 1,
            ],
